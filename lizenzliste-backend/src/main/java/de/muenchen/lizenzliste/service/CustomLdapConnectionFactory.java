...
public class CustomLdapConnectionFactory extends DefaultLdapConnectionFactory {
    ...
    public CustomLdapConnectionFactory(LdapConnectionProperties properties) {
    ...
    private static LdapConnectionConfig configBuilder(LdapConnectionProperties properties) {
